var ActivityStaticAnalysis = function() {
	return {
		staticAnalysisDataUpdate: function(group, tool_type, data) {
    	...
    	staticAnalysisFilterUpdate: function(group, tool_type, data) {    		
    		...
    		this.staticAnalysisEvent(group, tool_type);
    	},
    	
    	staticAnalysisEvent: function(group, tool_type) {
    		$("#" + group + "_" + tool_type + "_filter li").on("click", function() {
    			...
    			mainDataService_jsonLoader.requestStaticAnalysisFilter(group, tool_type);
    			mainDataService_jsonLoader.requestStaticAnalysisData(group, tool_type, selectedFilter);
    	    });
    	}
    };
}();